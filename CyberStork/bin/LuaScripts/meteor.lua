...
meteor["instantiate"] = function (params)
...
meteor["start"] = function (_self, lua)
  ...
  print("ayyy es nulo ")
  else lua:getRigidbody(lua:getEntity("testScene3")):setPosition(v3)
  end
  ...
  print(resta.y)
  print(resta.z)
  lua:getRigidbody(lua:getEntity("testScene3")):setLinearVelocity(Vector3(resta.x*1000 ,resta.y *1000 ,resta.z *10000))
